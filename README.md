# MinnPost's 2022 Races to Watch

Tracking Minnesota races to watch for the 2022 election
...
1. Install `git`
1. Get the code: `git clone https://github.com/MinnPost/minnpost-races-to-watch-2022.git`
1. Change the directory: `cd minnpost-races-to-watch-2022`
...
This application can be run locally, but it can also be deployed to Heroku. If you are creating a new Heroku application, clone this repository with `git clone https://github.com/MinnPost/minnpost-races-to-watch-2022.git` and follow [Heroku's instructions](https://devcenter.heroku.com/articles/git#create-a-heroku-remote) to create a Heroku remote.
